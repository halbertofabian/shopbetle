...
<head>
    ...
    <link rel="icon" href="<?= HTTP_HOST . 'app/assets/' ?>images/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="<?= HTTP_HOST . 'app/assets/' ?>images/favicon.png" type="image/x-icon">
    ...
    <!-- Font Awesome-->
    <link rel="stylesheet" type="text/css" href="<?= HTTP_HOST . 'app/assets/' ?>css/fontawesome.css">
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="<?= HTTP_HOST . 'app/assets/' ?>css/icofont.css">
    <!-- Themify icon-->
    ...
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="<?= HTTP_HOST . 'app/assets/' ?>css/animate.css">
    <link rel="stylesheet" type="text/css" href="<?= HTTP_HOST . 'app/assets/' ?>css/chartist.css">
    <link rel="stylesheet" type="text/css" href="<?= HTTP_HOST . 'app/assets/' ?>css/date-picker.css">
    <link rel="stylesheet" type="text/css" href="<?= HTTP_HOST . 'app/assets/' ?>css/prism.css">
    <link rel="stylesheet" type="text/css" href="<?= HTTP_HOST . 'app/assets/' ?>css/vector-map.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    ...
    <link id="color" rel="stylesheet" href="<?= HTTP_HOST . 'app/assets/' ?>css/color-1.css" media="screen">
    <!-- Responsive css-->
    <link rel="stylesheet" type="text/css" href="<?= HTTP_HOST . 'app/assets/' ?>css/responsive.css">
</head>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="page-main-header">
            <div class="main-header-right row m-0">
                <div class="main-header-left">
                    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/logo/logo.png" alt=""></a></div>
                    <div class="dark-logo-wrapper"><a href="index.html"><img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/logo/dark-logo.png" alt=""></a></div>
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown"><i data-feather="message-square"></i>
                            <ul class="chat-dropdown onhover-show-div">
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="<?= HTTP_HOST . 'app/assets/' ?>images/user/4.jpg" alt="">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="<?= HTTP_HOST . 'app/assets/' ?>images/user/1.jpg" alt="">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="<?= HTTP_HOST . 'app/assets/' ?>images/user/2.jpg" alt="">
        ...
        <div class="page-body-wrapper sidebar-icon">
            ...
            <header class="main-nav">
                <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/1.png" alt="">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-bordernone">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/product-1.png" alt="" data-original-title="" title="">
                                                            ...
                                                            <td><img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/graph-1.png" alt="" data-original-title="" title=""></td>
                                                            <td>
                                                                <p>$210326</p>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/product-2.png" alt="" data-original-title="" title="">
                                                            ...
                                                            <td><img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/graph-2.png" alt="" data-original-title="" title=""></td>
                                                            <td>
                                                                <p>$548526</p>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/product-3.png" alt="" data-original-title="" title="">
                                                            ...
                                                            <td><img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/graph-3.png" alt="" data-original-title="" title=""></td>
                                                            <td>
                                                                <p>$589565</p>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/product-4.png" alt="" data-original-title="" title="">
                                                            ...
                                                            <td><img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/graph-4.png" alt="" data-original-title="" title=""></td>
                                                            <td>
                                                                <p>$125424 </p>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/product-5.png" alt="" data-original-title="" title="">
                                                            ...
                                                            <td><img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/graph-5.png" alt="" data-original-title="" title=""></td>
                                                            <td>
                                                                <p>$112103</p>
                                                            </td>
                                                            <td>
     ...
     &lt;table class="table table-bordernone"&gt;
       ...
       &lt;tbody&gt;
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/product-1.png" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/graph-1.png" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$210326&lt;/p&gt;
           &lt;/td&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/product-2.png" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/graph-2.png" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$548526&lt;/p&gt;
           &lt;/td&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/product-3.png" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/graph-3.png" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$589565&lt;/p&gt;
           &lt;/td&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/product-4.png" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/graph-4.png" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$125424 &lt;/p&gt;
           &lt;/td&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/product-5.png" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="<?= HTTP_HOST . 'app/assets/' ?>images/dashboard/graph-5.png" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$112103&lt;/p&gt;
           &lt;/td&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <!-- latest jquery-->
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/jquery-3.5.1.min.js"></script>
    <!-- feather icon js-->
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/icons/feather-icon/feather.min.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/icons/feather-icon/feather-icon.js"></script>
    <!-- Sidebar jquery-->
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/sidebar-menu.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/config.js"></script>
    <!-- Bootstrap js-->
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/bootstrap/popper.min.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/bootstrap/bootstrap.min.js"></script>
    <!-- Plugins JS start-->
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/chart/chartist/chartist.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/chart/chartist/chartist-plugin-tooltip.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/chart/knob/knob.min.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/chart/knob/knob-chart.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/chart/apex-chart/apex-chart.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/chart/apex-chart/stock-prices.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/prism/prism.min.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/clipboard/clipboard.min.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/counter/jquery.waypoints.min.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/counter/jquery.counterup.min.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/counter/counter-custom.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/custom-card/custom-card.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/notify/bootstrap-notify.min.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/vector-map/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/vector-map/map/jquery-jvectormap-world-mill-en.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/vector-map/map/jquery-jvectormap-us-aea-en.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/vector-map/map/jquery-jvectormap-uk-mill-en.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/vector-map/map/jquery-jvectormap-au-mill.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/vector-map/map/jquery-jvectormap-chicago-mill-en.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/vector-map/map/jquery-jvectormap-in-mill.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/vector-map/map/jquery-jvectormap-asia-mill.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/dashboard/default.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/notify/index.js"></script>
    <script src="<?= HTTP_HOST . 'app/assets/' ?>js/datepicker/date-picker/datepicker.js"></script>
